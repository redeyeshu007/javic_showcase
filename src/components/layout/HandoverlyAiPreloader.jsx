...
export default function HandoverlyAiPreloader() {
          ...
          <div className="relative z-10 flex flex-col items-center justify-center">
            ...
            <div className="w-full flex justify-center mb-2">
              <img
                src={handoverlyLogo}
                alt="Handoverly AI"
                className="h-20 md:h-28 w-auto block mx-auto object-contain mix-blend-multiply contrast-[1.25] brightness-[1.1]"
